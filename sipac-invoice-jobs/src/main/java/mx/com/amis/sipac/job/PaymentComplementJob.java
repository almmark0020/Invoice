...
@Service("paymentComplementJob")
public class PaymentComplementJob {
  private static final Logger logger = LoggerFactory.getLogger(PaymentComplementJob.class);
  
  @Value("${kafka.topic.invoice.complement}")
  ...
  public void process() {
    ...
    List<OrderToInvoice> orders = repository.getPaidOrdersToInvoice();
