...
@Service("autAcceptanceJob")
public class AutAcceptanceJob {
	private static final Logger logger = LoggerFactory.getLogger(AutAcceptanceJob.class);

	@Value("${kafka.topic.invoice.automaticAcceptance}")
	...
	public void process() {
		...
		List<OrderToInvoice> orders = repository.getOrdersAutAcceptanceToInvoice();
