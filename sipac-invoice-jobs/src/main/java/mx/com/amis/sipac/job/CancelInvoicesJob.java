...
@Service("cancelInvoicesJob")
public class CancelInvoicesJob {
  private static final Logger logger = LoggerFactory.getLogger(CancelInvoicesJob.class);
  
  @Value("${kafka.topic.invoice.cancel}")
