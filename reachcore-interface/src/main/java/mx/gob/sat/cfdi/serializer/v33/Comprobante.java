...
public class Comprobante {
  ...
  public String getUUID() {
    for (Complemento compl : getComplemento()) {
      if (compl.getTimbreFiscalDigital() != null) {
        return compl.getTimbreFiscalDigital().getUUID();
      }
    }
    return null;
  }
  ...
  public static class Complemento {
    ...
    public TimbreFiscalDigital getTimbreFiscalDigital() {
      if (any != null && !any.isEmpty()) {
        for (Object obj : any) { 
          if (obj instanceof TimbreFiscalDigital) {
            TimbreFiscalDigital tfd = (TimbreFiscalDigital) obj;
            return tfd;
          }
        }
      }
      ...
      public Pagos getPagos() {
        if (any != null && !any.isEmpty() && any.get(0) instanceof Pagos) {
          Pagos tfd = (Pagos) any.get(0);
          return tfd;
        }
        return null;
      }
