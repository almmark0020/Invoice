...
public class Receiver {
  ...
  public void receiveCancel(String message) {
    ...
    try {
      ...
      if (resp != null && !resp.isError()) {
        FacMovimientoFacturacion mov = buildCancelInvoiceMovement(order, EstatusFacturacionEnum.CANCELACION, resp.getAcuseSAT());
  ...
  private FacMovimientoFacturacion buildCancelInvoiceMovement(OrderToInvoice order, EstatusFacturacionEnum status, String acuseSAT) throws Exception {
